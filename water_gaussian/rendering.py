...
from cudalight._wrapper import (
...
from water_gaussian.rasterizerlight.distributed import (
    all_gather_int32,
    all_gather_tensor_list,
    all_to_all_int32,
    all_to_all_tensor_list,
)
from water_gaussian.utils.gsplat_utils import depth_to_normal, get_projection_matrix
# change from https://github.com/nerfstudio-project/gsplat/blob/main/gsplat/rendering.py
...
def _rasterization(
    ...
    """
    from cudalight._torch_impl import (
